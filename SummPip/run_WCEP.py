...
def read_arguments():
    ...
    parser.add_argument("--source_file", type=str, default="WCEP_title_testX")
    ...
    parser.add_argument("--nb_words", type=int, default=1)
    parser.add_argument("--nb_clusters", type=int, default=1,help="for spectral clustering")
...
def main():
    ...
    # src_list = read_file(path, src_file)[:5093]
