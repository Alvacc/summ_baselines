...
class Translator(object):
    ...
    def translate(self,
        ...
        # write the parsing_info fields
        data.fields["parsing_info"] = self.fields["parsing_info"]
    ...
    def _translate_batch(self, batch, data):
        ...
        enc_states, memory_bank = self.model.encoder(src, src_lengths, batch.parsing_info)
        dec_states = self.model.decoder.init_decoder_state(
