...
def validate_online(valid_iter_fct, trainer, step):

    print('Step', str(step), ', start validation...')
            ...
            for i, batch in enumerate(train_iter):
                if self.n_gpu == 0 or (i % self.n_gpu == self.gpu_rank):
                    ...
                    if accum == self.grad_accum_count:
                        ...
                        # print('Step', str(step), ', start training...')
                        ...
                        # if step % 10000 == 0:
                        #     # validate on the fly
                        #     validate_online(valid_iter_fct, self, step)
                        #     self.model.train()
    ...
    def validate(self, valid_iter):
        ...
        with torch.no_grad():
            for batch in valid_iter:
                ...
                outputs, _ = self.model(src, tgt, parsing_info)
