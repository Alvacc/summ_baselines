...
def main():
    ...
    if hps.model == "HSG":
        ...
        valid_loader = torch.utils.data.DataLoader(valid_dataset, batch_size=hps.batch_size, shuffle=False,collate_fn=graph_collate_fn, num_workers=0)  # Shuffle Must be False for ROUGE evaluation
    else:
